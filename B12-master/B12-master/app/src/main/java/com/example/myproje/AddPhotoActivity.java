        ...
        if (imageData != null) {
            ...
            storageReference.child(imageName).putFile(imageData).addOnSuccessListener(taskSnapshot -> {
                ...
                newReference.getDownloadUrl().addOnSuccessListener(uri -> {
                    ...
                    String comment = (binding.addComment.getText() != null) ? binding.addComment.getText().toString() : "";

                    FirebaseUser user = auth.getCurrentUser();
                    if (user == null || user.getEmail() == null) {
                        Toast.makeText(AddPhotoActivity.this, "Kullanıcı oturumu bulunamadı!", Toast.LENGTH_SHORT).show();
                        return;
                    }
                    ...
                    firebaseFirestore.collection("Photos").add(postData)

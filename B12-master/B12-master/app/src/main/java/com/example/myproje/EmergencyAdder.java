    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        binding.emergencyAddButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String name = (binding.emergencyAddName.getText() != null) ? binding.emergencyAddName.getText().toString() : "";
                String number = (binding.emergencyAddNumber.getText() != null) ? binding.emergencyAddNumber.getText().toString() : "";

                FirebaseUser user = auth.getCurrentUser();
                if (user == null || user.getEmail() == null) {
                    Toast.makeText(EmergencyAdder.this, "Kullanıcı oturumu bulunamadı!", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                firebaseFirestore.collection("Emergency").add(EmergencyData)
